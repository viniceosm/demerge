...
contentType:!1,processData:!1,method:"POST",type:"POST",success:function(a){$("#btnCloseModal").click();setTimeout(function(){$("#btnPostar").prop("disabled",!1)},2E3)}});a.preventDefault()});$.each($("#dropdown-notificacoes .aNotificacao"),function(a,b){$(b).click(function(a){$(location).attr("href",$(b).attr("href-notificacao"))})})});function seguir(a){socket.emit("seguir",a)}socket.on("retornoSeguir",function(a){$("#btnSeguir").html("Seguir");1==a&&$("#btnSeguir").html("Seguindo")});
function curtir(a){socket.emit("curtirPost",a)}socket.on("retornoCurtir",function(a){$("#qCurtiu"+a.idPost).html(a.qCurtiu);$("#btnLike"+a.idPost).css("color","black");1==a.isCurte&&$("#btnLike"+a.idPost).css("color","red")});function validaPesquisa(a){return""!==a.trim()};