...
app.use('/js', express.static(__dirname + '/public/material-kit/js'));
app.use('/css', express.static(__dirname + '/public/css'));
app.use('/css', express.static(__dirname + '/public/material-kit/css'));
app.use('/font', express.static(__dirname + '/public/material-kit/font'));
